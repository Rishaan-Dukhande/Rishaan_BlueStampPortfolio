...
The 3D case design was initally developed with dimensions from the Adafruit case the project was supposed to be encased in. These dimensions were incorrect, so manual dimensions were needed for the next print. Then it was decided to add an acrylic plate to see the build instead of printing the lid in PETG transluecent filament. I designed shelves for a 1mm thick acyrlic plate, but once the print was finished there was only a 2mm thick acrylic plate to use. Eventually, the shelves were removed and the acrylic was glued to the back of the case while making a top shelf to make it look like a picture frame. Even though the 3D case was printed with larger dimensions, each component of the IoT pollution monitor was squished inside the box. Sometimes parts would lose connection and the components would have to be taken out and re-intalled. 
